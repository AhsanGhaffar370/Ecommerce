...
<div class="container body">
	...
	<div class="col-md-3 left_col">
		...
		<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
			...
			<h3>E-Commerce</h3>
			<ul class="nav side-menu">
				<li><a><i class="fa fa-bug"></i> Manage Products <span class="fa fa-chevron-down"></span></a>
				<ul class="nav child_menu">
					<li><a href="{{ route('admin.products.index') }}">List Products</a></li>
					<li><a href="{{ route('admin.products.create') }}">Create Product</a></li>
				</ul>
				</li>	
				<li><a><i class="fa fa-bug"></i> Manage Categories <span class="fa fa-chevron-down"></span></a>
				<ul class="nav child_menu">
